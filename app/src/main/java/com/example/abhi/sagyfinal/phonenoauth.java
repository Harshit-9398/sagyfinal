   ...
   /*  FirebaseAuth auth;
     ...
     PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_phonenoauth);


            t1 = (EditText) findViewById(R.id.phoneno);
            t2 = (EditText) findViewById(R.id.otpcode);

            b1 = (Button) findViewById(R.id.sendsms);
            b2 = (Button) findViewById(R.id.verifycode);
            auth = FirebaseAuth.getInstance();
            mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                @Override
                public void onVerificationCompleted(PhoneAuthCredential phoneAuthCredential) {
                    Toast.makeText(phonenoauth.this,"done",Toast.LENGTH_SHORT).show();
                }

                @Override
                public void onVerificationFailed(FirebaseException e) {
                    Toast.makeText(phonenoauth.this,"failed",Toast.LENGTH_SHORT).show();
                ...
                auth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                      if(task.isSuccessful()){
                          Toast.makeText(phonenoauth.this,"signed successfully",Toast.LENGTH_SHORT).show();
            ...
            public void verify(View v) {
                String input_code = t2.getText().toString();
        ...
        public class phonenoauth extends AppCompatActivity  implements
